...
export class GroupService extends BasicService<Group> {
  ...
  public getMemberList(filter: any = null, sort: any = null, limit: number = null, skip: number = null): Observable<Group[]> {

    return this.http.post(this.Url + 'memberGroups', {
      filter,
      sort,
      limit,
      skip
  ...
  public setActiveGroup(groupId: string): Observable<string> {
    return this.http.post(this.Url + 'setActiveGroup', { Id: groupId })
